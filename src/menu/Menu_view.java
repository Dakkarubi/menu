...
public class Menu_view extends Frame implements ActionListener,WindowListener {
	...
	public Menu_view() {
		...
		JFreeChart chart1=
				ChartFactory.createLineChart("import Volume","year","Ton",data1,PlotOrientation.VERTICAL,true,false,false);
		...
		JFreeChart chart2=
				ChartFactory.createLineChart("import Volume","year","Ton",data2,PlotOrientation.VERTICAL,true,false,false);
